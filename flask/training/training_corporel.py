...
def training_corporel(es, dataC):
    ...
    aggregation = {"Trafic redressé":'mean',"Total alertes Waze":'mean', "N_SHAPEPNT":'mean',"Nombre alertes Waze BOUCHONS":'mean', "Nombre alertes Waze DANGERROUTE":'mean',"Nombre total d'alertes Coyote":'mean', MATERIEL:"mean"}
    ...
    path = 'training/Barometre_corporel.pkl'
    baro_.save(path)
    return baro_
